using NCMS.Backend.Persistence.Inteceptors;
...
public static class PersistenceExtensions
{
    ...
    public static IServiceCollection AddNcmsDatabaseOptions(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    public static IServiceCollection AddNcmsDbContext<TContext>(this IServiceCollection services)
        where TContext : DbContext
    {
        ...
        services.AddDbContext<TContext>((sp, options) =>
        {
            ...
            options.ConfigureNcmsDatabase(dbConfig.Provider, dbConfig.ConnectionString, dbConfig.MigrationsAssembly, env.IsDevelopment());
